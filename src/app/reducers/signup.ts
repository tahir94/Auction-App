import {
    DEMO, DEMO_SUCCESS, SIGNUP_SUCCESS, SIGNUP_FAILED,
...
export const signupSuccess = (action, state) => {
    ...
    return tassign(state, {
        ...
        currentUserUid: uid, currentUserName: userName,
...
export const loginSuccess = (state, action) => {
    ...
    return tassign(state, {
        ...
        currentUserUid: currentUserUid, isLoading: false
    })
}
...
export const signupReducer = (state: SignupState = SIGNUP_INITIAL_STATE, action) => {


    switch (action.type) {

        case SIGNUP_SUCCESS: return signupSuccess(action, state);
        case SIGNUP_FAILED: return signupFailed(action, state);
